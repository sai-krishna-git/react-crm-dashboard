...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen lg:ml-56 md:ml-40 sm:ml-0 px-10 mt-0 transition-all duration-300">
      {/* Title */}
      ...
      <p className="text-gray-900 text-lg text-center max-w-3xl mb-6 leading-loose">
        Welcome to our CRM Dashboard! Our system empowers businesses to track orders, 
        manage products, and enhance customer relationships with efficiency and ease.
      </p>
